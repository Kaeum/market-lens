...
class SnapshotReader(
    ...
    override suspend fun findByStockCodeIn(stockCodes: List<String>): List<StockPriceSnapshot> {
    ...
    override suspend fun findById(stockCode: String): StockPriceSnapshot? {
